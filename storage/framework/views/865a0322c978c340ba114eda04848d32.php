...
<head>
    ...
    <title>Đơn hàng mới #<?php echo e($order->code); ?></title>
        ...
        <table class="main" width="100%">
                    ...
                    <table width="100%" style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; margin-bottom: 20px;">
                        <tr>
                            <td style="padding: 20px; text-align: center; border-right: 1px solid #e2e8f0;" width="50%">
                                ...
                                <div style="font-size: 18px; font-weight: 700; color: #004a99;">#<?php echo e($order->code); ?></div>
                            </td>
                            <td style="padding: 20px; text-align: center;">
                                <div class="label">Tổng giá trị</div>
                                <div style="font-size: 18px; font-weight: 700; color: #ef4444;"><?php echo e(number_format($order->total_amount, 0, ',', '.')); ?> đ</div>
                            </td>
                        </tr>
                    </table>
                </td>
                        ...
                        <tr>
                            <td width="50%" valign="top" class="mobile-block" style="padding-right: 20px;">
                                ...
                                <div>
                                    ...
                                    <div class="value" style="font-size: 14px; color: #555;">
                                        <?php echo e($order->note ? $order->note : 'Không có ghi chú'); ?>
                            ...
                            <td width="50%" valign="top" class="mobile-block">
                                ...
                                <div style="margin-bottom: 15px;">
                                    ...
                                    <div class="value" style="font-weight: 500;"><?php echo e($order->created_at->format('d/m/Y H:i')); ?></div>
                                </div>
                                ...
                                <?php if($order->payment_proof): ?>
                                    <div style="margin-top: 15px; border: 1px dashed #004a99; padding: 10px; background: #f0f7ff; border-radius: 6px;">
                                        ...
                                        <img src="<?php echo e($message->embed(storage_path('app/public/' . $order->payment_proof))); ?>" 
                                             alt="Payment Proof" 
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" style="border: 1px solid #e2e8f0; border-radius: 6px; overflow: hidden;">
                        ...
                        <tbody>
                            ...
                            <tr style="border-top: 1px solid #e2e8f0;">
                                ...
                                <td align="center" style="padding: 12px; font-size: 14px; font-weight: 600; color: #334155;"><?php echo e($item->quantity); ?></td>
            ...
            <tr>
                <td style="padding: 10px 40px 40px 40px; text-align: center;" class="mobile-padding">
                    <a href="<?php echo e(route('orders.index')); ?>" style="background-color: #004a99; color: #ffffff; padding: 14px 30px; text-decoration: none; font-size: 14px; font-weight: 600; display: inline-block; border-radius: 6px; box-shadow: 0 4px 6px rgba(0, 74, 153, 0.2);">
...
</html><?php /**PATH C:\Users\NHUY\Desktop\huykhanhstore\huykhanhstoreapp\resources\views/emails/order_placed.blade.php ENDPATH**/ ?>