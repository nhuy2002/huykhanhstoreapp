...
<div class="mobile-menu-container">
    ...
    <div id="mb-sidebar" class="mobile-sidebar">
        ...
        <div class="sidebar-content">
            <ul class="sidebar-menu-list">
                ...
                <li class="sidebar-menu-item">
                    <a href="<?php echo e(route('profile.show')); ?>" class="sidebar-menu-link">Thông tin cá nhân</a>
                </li>
                ...
                <li class="sidebar-menu-item sidebar-menu-dropdown">
                    ...
                    <ul id="mobile-sales-dropdown-menu" class="sidebar-dropdown-menu" aria-label="Bán hàng">
                        <li><a href="<?php echo e(route('orders.create')); ?>" class="sidebar-dropdown-item">Tạo đơn hàng</a></li>
                        <li><a href="<?php echo e(route('orders.index')); ?>" class="sidebar-dropdown-item <?php if(Auth::user()->role != 'admin'): ?> sidebar-dropdown-item-disabled <?php endif; ?>">Quản lý đơn hàng</a></li>
                    </ul>
                </li>
                <li class="sidebar-menu-item">
                    <a href="<?php echo e(route('users.index')); ?>" class="sidebar-menu-link <?php if(Auth::user()->role != 'admin'): ?> sidebar-menu-link-disabled <?php endif; ?>">Quản lý tài khoản</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <nav class="mtb-navbar">
        ...
        <a href="<?php echo e(route('orders.create')); ?>" class="mtb-item">
                <div class="mtb-icon">
        ...
        <a href="<?php echo e(route('profile.show')); ?>" class="mtb-item">
            <div class="mtb-icon">
...
<?php /**PATH C:\Users\NHUY\Desktop\huykhanhstore\huykhanhstoreapp\resources\views/components/mobile-menu.blade.php ENDPATH**/ ?>