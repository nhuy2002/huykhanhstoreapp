...
<link rel="stylesheet" href="<?php echo e(asset('css/pos-custom.css')); ?>">

<form action="<?php echo e(route('orders.checkout')); ?>" method="POST" id="pos-form">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\NHUY\Desktop\huykhanhstore\huykhanhstoreapp\resources\views/orders/create.blade.php ENDPATH**/ ?>